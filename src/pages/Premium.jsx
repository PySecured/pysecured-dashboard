import { BarChart3, Database, ShieldCheck, ShieldAlert, CalendarClock, FileText, Palette, Gauge, ArrowRight, Check } from 'lucide-react'
...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Snapshot your roles, categories, and channels, then restore them whenever you need. Restoring only ever adds — it never deletes or modifies anything currently in your server, so a bad restore can't make things worse.",
    bullets: [
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative max-w-3xl mx-auto px-6 pt-16 pb-14 text-center">
          ...
          <div className="surface inline-flex flex-col sm:flex-row items-center gap-3 rounded-xl border border-[var(--py-blue)]/30 px-5 py-4 mb-8 text-left">
      ...
      <section className="relative max-w-4xl mx-auto px-6 pb-16">
        ...
        <Reveal delay={200}>
          <p className="text-center text-xs text-[var(--mist-dim)] mt-10 max-w-md mx-auto leading-relaxed">
            No price and no billing yet — we'd rather get it right than rush it out.
            The Discord is the most accurate place to hear when that changes.
          </p>
        </Reveal>
      </section>
