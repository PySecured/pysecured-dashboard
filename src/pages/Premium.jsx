...
export default function Premium() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      <SEO
        title="Premium"
        description="PySecured Premium — real analytics and server backup & restore, currently out for QA testing. Everything else stays free."
        path="/premium"
      />
      <SiteHeader />
      ...
      <section className="relative">
        ...
        <div className="relative max-w-3xl mx-auto px-6 pt-16 pb-14 text-center">
          ...
          <p className="text-[var(--mist)] text-base sm:text-lg leading-relaxed max-w-lg mx-auto mb-8">
            Moderation, tickets, reaction roles, giveaways, welcome messages, custom commands,
            leveling, and starboard — all free, no premium wall. Premium is for the handful of
            things that genuinely need more work to build right, currently in QA testing with
            our Discord's QA Team.
          </p>
          <a
