            ...
            <>
              <div className="surface inline-flex flex-col sm:flex-row items-center gap-3 rounded-2xl border border-[var(--py-blue)]/30 px-5 py-4 mb-8 text-left">
                ...
                <p className="text-sm text-[var(--mist-dim)]">
                  Every feature below is live. Pick a plan and your premium role is applied
                  to your Discord account automatically.
                </p>
              </div>
      ...
      <section className="relative max-w-4xl mx-auto px-6 sm:px-10 pb-16">
        ...
        <Reveal delay={200}>
          <p className="text-center text-xs text-[var(--mist-dim)] mt-10 max-w-md mx-auto leading-relaxed">
            {hasPremium
              ? "Thanks for supporting PySecured — these features keep evolving, and feedback in the Discord genuinely shapes them."
              : "Paid securely through PayPal. Cancel any time by simply not renewing — nothing recurring is charged automatically."}
          </p>
        </Reveal>
      </section>
