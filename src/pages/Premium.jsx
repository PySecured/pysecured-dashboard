...
const AVAILABLE_NOW = [
  {
    Icon: Ticket,
    title: 'A fully customizable ticket system',
    body: "A panel embed with a button that opens a private channel per person — configure the panel's channel, which category tickets are created under, which roles can see and reply to them, a dedicated log channel with a transcript on close, and the panel's title, description, button label, and color, all from the dashboard.",
    bullets: [
      'Custom embed — title, description, color, button label',
      'Pick the category tickets are created in',
      'Choose exactly which roles can access tickets',
      'Dedicated log channel with a transcript on close',
    ],
  },
  {
    Icon: BarChart3,
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-5 mt-4 max-w-2xl">
