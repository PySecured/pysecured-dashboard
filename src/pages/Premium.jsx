import { BarChart3, Database, ShieldCheck, ShieldAlert, ShieldX, Timer, CalendarClock, FileText, Palette, Gauge, Sparkles, ArrowRight, Check } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative">
        ...
        />
        <div className="relative max-w-3xl px-6 sm:px-10 pt-16 pb-14 text-center">
      ...
      <section className="relative max-w-4xl px-6 sm:px-10 pb-16">
        <Reveal>
