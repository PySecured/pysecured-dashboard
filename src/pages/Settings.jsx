  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between pb-4 border-b border-[var(--line)] sticky top-0 z-20 bg-[var(--bg)]/80 backdrop-blur-md pt-4 -mt-4">
          <button
              ...
              {(config.stats_channels || []).map((st, i) => (
                <div key={i} className="flex items-center gap-2">
                  <select
                    ...
                    className="w-44 shrink-0 rounded-lg bg-[var(--bg-raised)] border border-[var(--line)] text-sm text-white px-3 py-2 field-focus"
                  >
