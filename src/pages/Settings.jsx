            ...
            <Section title="Action" description="What happens when a message is flagged">
              ...
              {config.action === 'role' && (
                <ActionButton
                  ...
                  description="Creates the role if needed and blocks it from sending/typing in every channel"
                  onRun={async () => {
          ...
          <>
            ...
            >
              ...
              <ActionButton
                ...
                description="Save your trap channel first — this posts and pins the warning message there"
                onRun={() => api.postTrapNotice(guildId)}
