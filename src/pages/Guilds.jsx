        ...
        <Reveal>
          <div className="flex items-start justify-between gap-4 mb-8">
            ...
            <button
              ...
              className="group shrink-0 inline-flex items-center gap-1.5 rounded-lg bg-[var(--discord)] hover:brightness-110 disabled:opacity-50 transition-all text-white text-sm font-medium px-4 py-2"
            >
          ...
          {configured.map((g, idx) => (
            <Reveal key={g.id} delay={idx * 60}>
              <button
                ...
                className="card-interactive w-full flex items-center gap-3 rounded-xl border border-[var(--line)] bg-[var(--bg-raised)]/60 p-4 text-left"
              >
                <GuildIcon guild={g} />
