...
import {
  ...
  ScrollText, Lightbulb, BarChart2, FileText, Sparkles, Moon, ShieldX, Pin,
} from 'lucide-react'
import { api } from '../api'
          ...
          <div>
            ...
            {status?.bot?.online && (
              <div className="grid grid-cols-3 gap-3 mt-10 max-w-md">
                ...
                <div className="surface rounded-xl border border-[var(--line)] px-3 py-3">
                  <p className="font-mono text-lg text-white leading-none mt-4">26<span className="text-xs text-[var(--mist-dim)]">+</span></p>
