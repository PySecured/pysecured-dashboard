...
const FAQ = [
  {
    ...
    a: "Yes. Every feature listed under Free is genuinely free with no usage caps designed to push you into paying. Premium exists, but it's a small set of harder-to-build features — and it isn't even purchasable yet.",
  },
  {
      ...
      <section className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-12 pb-24 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight text-white mb-6">
              The all-in-one<br />bot for Discord
            </h1>
            <p className="text-[var(--mist)] text-base sm:text-lg leading-relaxed mb-8 max-w-md">
            ...
            {status?.bot?.online && (
              <div className="grid grid-cols-3 gap-3 mt-10 max-w-md">
                ...
                <div className="surface rounded-xl border border-[var(--line)] px-3 py-3">
                  <p className="font-mono text-lg text-white leading-none mt-4">28<span className="text-xs text-[var(--mist-dim)]">+</span></p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f, idx) => (
            <Reveal key={f.title} delay={idx * 80}>
              <div className="card-interactive h-full surface rounded-2xl border border-[var(--line)] p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  {f.premium && (
                    <span className="crown" title="Premium feature">
      ...
      <section className="relative max-w-4xl mx-auto px-6 py-14 sm:py-20">
        <Reveal>
          ...
          <p className="text-[var(--mist)] text-center max-w-lg mx-auto mb-10">
            No feature is crippled to push you into paying. Premium is a handful of things that
            are genuinely harder to build — and it isn't even on sale yet.
          </p>
        </Reveal>
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          <Reveal delay={100}>
            <div className="surface rounded-2xl border border-[var(--py-blue)]/40 p-6 h-full">
              ...
              <p className="text-xs text-[var(--mist-dim)] mb-5">Live now — granted by hand, not yet for sale</p>
              <ul className="space-y-2">
                {PREMIUM_LIST.map((f) => (
                  <li key={f} className="flex items-start gap-2.5 text-sm text-[var(--mist)]">
