  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative max-w-3xl mx-auto px-6 pt-16 sm:pt-24 pb-16 text-center">
          <div>
      ...
      <section className="relative max-w-6xl mx-auto px-6 py-14 sm:py-20">
        ...
        <Reveal>
          ...
          <p className="text-[var(--mist)] max-w-xl mb-10">
            Recovery, insight, and control. Live now — granted by hand while we finish
            building the purchase flow.
          </p>
        </Reveal>
