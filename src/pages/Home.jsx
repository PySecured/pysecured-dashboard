...
const STRUCTURED_DATA = {
  ...
  description:
    'PySecured is an all-in-one Discord bot — security and hacked-account detection, tickets, reaction roles, giveaways, welcome messages and auto-role, analytics, and a full web dashboard.',
...
const FEATURES = [
  {
    ...
    body: 'Catches hacked accounts by behavior — scam links, fake giveaways, mass pings — and automatically quarantines, times out, kicks, or bans. Includes a honeypot trap channel.',
  },
  {
    Icon: Ticket,
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <SEO
        ...
        description="Security, tickets, reaction roles, giveaways, welcome messages, and a full web dashboard — one Discord bot, mostly free."
        path="/"
      />
      <Helmet>
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-12 pb-24 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="text-[var(--mist)] text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
              ...
              giveaways, and reaction roles, welcomes new members automatically — all from
              one dashboard, mostly free.
            </p>
            ...
            {status?.bot?.online && (
              <div className="grid grid-cols-3 gap-3 mt-10 max-w-md">
                <div className="rounded-xl border border-[var(--line)] bg-[var(--bg-raised)]/60 px-3 py-3">
                ...
                <div className="rounded-xl border border-[var(--line)] bg-[var(--bg-raised)]/60 px-3 py-3">
                  <p className="font-mono text-lg text-white leading-none mt-4">6<span className="text-xs text-[var(--mist-dim)]">+</span></p>
