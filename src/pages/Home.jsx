...
import {
  ...
  ScrollText, Lightbulb, BarChart2, FileText, Sparkles, Moon, ShieldX, Pin, Undo2, Mail,
} from 'lucide-react'
import { api } from '../api'
      ...
      <section className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-12 pb-24 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] sm:leading-[1.05] mb-6">
