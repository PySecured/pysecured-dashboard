...
import { ArrowRight, Terminal, Radio, Sparkles, Smile, Gift, Ticket } from 'lucide-react'
import { api } from '../api'
...
const MORE_FEATURES = [
  {
    ...
    body: 'A panel button opens a private channel per person — custom category, support roles, and a log with a transcript on close.',
  },
  {
    Icon: Smile,
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-12 pb-24 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h1 className="font-display text-4xl sm:text-6xl font-bold leading-[1.05] mb-6">
              <span className="text-white">Catch hacked accounts before they </span>
            ...
            {status?.bot?.online && (
              <div className="grid grid-cols-3 gap-3 mt-10 max-w-md">
                ...
                <div className="rounded-xl border border-[var(--line)] bg-[var(--bg-raised)]/60 px-3 py-3">
                  <p className="font-mono text-lg text-white leading-none mt-4">100<span className="text-xs text-[var(--mist-dim)]">%</span></p>
                  <p className="text-[10px] text-[var(--mist-dim)] mt-1.5">free features</p>
                </div>
              </div>
            )}
          </div>
