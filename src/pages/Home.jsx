...
const STRUCTURED_DATA = {
  ...
  description:
    'PySecured is a Discord moderation bot that detects compromised (hacked) accounts by their behavior — scam links, fake nitro giveaways, mass-ping spam — and automatically quarantines, times out, kicks, or bans them.',
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <SEO
        title="PySecured — Discord Anti-Spam & Anti-Hack Moderation Bot"
        description="PySecured is a free Discord moderation bot that catches hacked and compromised accounts before they spam scam links, fake nitro giveaways, or mass pings in your server."
        path="/"
      />
      <Helmet>
      ...
      <section className="relative max-w-6xl mx-auto px-6 py-20">
        <Reveal className="card-interactive rounded-2xl border border-[var(--line)] bg-[var(--bg-raised)]/60 px-8 py-14 text-center">
          ...
          <a
            href={api.loginUrl()}
            className="group inline-flex items-center gap-2 rounded-lg bg-[var(--discord)] hover:brightness-110 transition-all text-white text-sm font-medium px-6 py-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--py-blue)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]"
          >
            Continue with Discord
            <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5" strokeWidth={2} />
          </a>
