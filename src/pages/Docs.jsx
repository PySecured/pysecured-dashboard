...
export default function Docs() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="relative max-w-3xl mx-auto px-6 sm:px-10 pb-20">
        <Reveal>
          <PageHeader
            eyebrow="Documentation"
            title="Everything PySecured does"
            subtitle="Every command and feature, what it's for, and where to turn it on. Nothing is enabled by default — the bot won't touch your server until you decide what you want."
            icon={BookOpen}
          />
