...
import { Activity, Wifi, Server, ShieldCheck, Settings2, Ticket, UserPlus, Clock, Cloud, Gauge, Users2, Timer, Gavel, Trophy, Star, Gift, Info } from 'lucide-react'
...
export default function Status() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-10 py-2">
        <PageHeader eyebrow="Status" title="System status" icon={Activity} />
