...
import { Wifi, Server, ShieldCheck, Settings2, Ticket, UserPlus, Clock, Cloud, Gauge, Users2, Timer } from 'lucide-react'
          ...
          <>
            ...
            <div className="rounded-xl border border-[var(--line)] bg-[var(--bg-raised)]/60 divide-y divide-[var(--line)] overflow-hidden mb-6">
              {data.components.map((c) => {
                ...
                return (
                  <div key={c.name} className="flex items-center justify-between px-5 py-3.5 transition-colors hover:bg-white/[0.02]">
