...
export default function Terms() {
  return (
    <LegalLayout title="Terms of Use" effectiveDate="August 9, 2026">
      <section>
      ...
      <section>
        <h2>9. Contact</h2>
        <p>
          Questions about these terms: <code className="font-mono text-xs">[your contact email or support server link]</code>
        </p>
      </section>
    </LegalLayout>
  )
