      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-10 pt-6 sm:pt-10 pb-6">
        ...
        <div className="surface rounded-2xl border border-[var(--line)] p-5 mb-4">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <Link
              to="/premium"
              className="press shrink-0 inline-flex items-center gap-1.5 rounded-xl btn-primary text-sm font-semibold px-4 py-2.5"
            >
        ...
        <div className="surface rounded-2xl border border-[var(--line)] p-5">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <button
              onClick={copyLink}
              className="press shrink-0 inline-flex items-center gap-1.5 rounded-lg btn-secondary text-sm font-medium px-3 py-2.5"
            >
              {copied
          ...
          <Link
            to="/leaderboard"
            className="press inline-flex items-center gap-1.5 text-sm text-[var(--py-blue)] hover:underline mt-4"
          >
            See the leaderboard
