...
export default function Staff() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-3xl px-6 sm:px-10 py-10">
        <p className="eyebrow mb-2">Staff</p>
        <h1 className="font-display text-2xl font-bold text-white mb-1">Support tools</h1>
        <p className="text-sm text-[var(--mist-dim)] mb-8">
          Read-only. Look up any server to see which modules are on and whether PySecured has the
          permissions it needs — enough to answer "why isn't this working?" without changing anyone's setup.
        </p>
