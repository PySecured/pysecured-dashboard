    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 sm:px-10 py-2">
        <PageHeader
          eyebrow="Staff"
          title="Support tools"
          subtitle="Read-only. Look up any server to see which modules are on and whether PySecured has the permissions it needs — enough to answer 'why isn't this working?' without changing anyone's setup."
          icon={LifeBuoy}
        />
