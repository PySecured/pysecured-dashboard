...
export default function Staff() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-10 pt-8 sm:pt-12 pb-16">
        <div className="mb-7">
          <p className="eyebrow mb-3">Staff</p>
          <h1 className="font-display text-2xl sm:text-3xl font-bold text-white">Support tools</h1>
