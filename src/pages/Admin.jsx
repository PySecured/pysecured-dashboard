...
import {
  ...
  Search, ChevronRight, LogOut, X as XIcon, Activity, RotateCcw, Eye,
} from 'lucide-react'
import { api } from '../api'
...
export default function Admin() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 sm:px-10 py-2">
        <PageHeader
          eyebrow="Admin"
          title="Site administration"
          subtitle="Maintenance and the announcement banner only affect the website — the bot keeps moderating servers normally either way. You can also open and manage any server below, whether or not you admin it in Discord."
          icon={ShieldCheck}
        />
