    ...
    <nav className="relative z-10 max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        {!loading && user && (
          <div className="flex items-center gap-3">
            {user.is_staff && !user.is_admin && (
              <Link
                to="/staff"
                className="inline-flex items-center gap-1 text-sm text-[var(--py-blue)] hover:brightness-125 transition-colors"
              >
        ...
        {!loading && !user && (
          <a
            href={api.loginUrl()}
            className="press rounded-lg bg-[var(--discord)] hover:brightness-110 transition-all text-white text-sm font-medium px-4 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--py-blue)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]"
          >
